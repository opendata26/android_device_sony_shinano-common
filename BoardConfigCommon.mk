...
TARGET_LD_SHIM_LIBS := \
    ...
    /system/vendor/lib/hw/camera.vendor.qcom.so|/system/vendor/lib/libsonycamera.so \
    /system/vendor/bin/mm-qcamera-daemon|libandroid.so \
    /system/vendor/lib/libcammw.so|libsensor.so \
    /system/vendor/lib/libsomc_chokoballpal.so|/system/vendor/lib/libshim_camera.so \
    /system/vendor/lib/libcald_pal.so|/system/vendor/lib/libshim_cald.so \
    /system/vendor/lib/hw/camera.vendor.qcom.so|libsensor.so 
